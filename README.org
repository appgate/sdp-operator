...
1. We will create first a new namespace in our cluster.
2. Then we will register the CRD data in k8s.
3. Finally we create the role allowing our pod to listen new events from the new
   CRD data.
